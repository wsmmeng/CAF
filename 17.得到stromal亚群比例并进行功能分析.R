...
DCmarker <- subset(stromalmarkers,cluster=='demosplastic CAFs')
...
pathway <- KKDCresult[c('hsa04974',"hsa04510","hsa04512","hsa04210","hsa04350"),]
library(DOSE)
...
save(ego_BHresultXX,'ego_BHresultXX.Rdata')
